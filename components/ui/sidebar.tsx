...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", userType, className, children, ...props }, ref) => {
  ...
  const labsItems = [
    { href: "/labs/predictor", icon: Brain, label: "Outcome Predictor" },
